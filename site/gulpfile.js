...
const copyFilteredCodelabs = (dest) =>  {
  ...
  // processing.
  console.log(`CODELABS_DIR=[${CODELABS_DIR}]`)
  console.log(`dest=[${dest}] CODELABS_NAMESPACE=[${CODELABS_NAMESPACE}]`)
  console.log(`CODELABS_FILTER=[${CODELABS_FILTER}] VIEWS_FILTER=[${VIEWS_FILTER}]`)
...
const collectCodelabs = () => {
  ...
  console.log(`codelabs=[${codelabs.join("\n")}]`)
